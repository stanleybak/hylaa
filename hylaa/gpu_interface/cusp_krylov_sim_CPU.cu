...
void arnoldi_parallel( int start_pos, int final_pos, int numIter, double* result_H)
{
    _arnoldi_parallel(start_pos, final_pos, numIter,result_H);
}
